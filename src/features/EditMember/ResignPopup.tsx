...
export default function ResignPopup({setOpen} : Props) {
    ...
    <div className='w-11/12 border aspect-[3/1] z-10 p-10 bg-white rounded-lg'>
        ...
        <div className="w-full flex justify-evenly mt-8">
            <button onClick={handleResign} className="w-1/3 aspect-[3/1] border-black border text-red-400 font-bold">탈퇴</button>
            <button onClick={()=>setOpen(false)} className="w-1/3 aspect-[3/1] border-black border">취소</button>
        </div>
    </div>
    )
}
