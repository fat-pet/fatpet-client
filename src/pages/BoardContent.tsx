  ...
  return (
      <div className='relative'>
            ...
            <div className='border-t-2 mt-10'>
                ...
                <form className='w-full flex justify-between items-center absolute -bottom-10 border-t-2 h-10' onSubmit={handleSubmit}>
                    <input 
