...
export default function BasicInformation() {
    ...
    function handleSumbit(data: SubmitProps) {
        ...
        createPet(
            ...
            neutered,
            feedCalories,
        ).then(() => navigate('/dashboard/petList'));
    }
                ...
                <div className="my-5 w-full">
                    ...
                    <div className="flex mt-2 w-full">
                        <Form.SelectButton
                            ...
                            icon={
                                <IoMdMale className="w-6 h-6 mr-2 text-blue-600" />
                            }
                        ...
                        <Form.SelectButton
                            ...
                            icon={
                                <IoMdFemale className="w-6 h-6 mr-2 text-red-600" />
                            }
