...
export default function DetailInformation() {
    ...
    const handleSubmit = (data : SubmitProps) =>{
        ...
        for (let key in data){apiData[key] = Number(data[key])}
        postDiagnoses(petData.id, apiData['체중'], apiData['목 둘레 길이'], apiData['가슴 둘레 길이'], apiData['사료 급여량(하루 평균)']  )
    }
    ...
    return (
        <div className="flex flex-col items-center h-full">
            ...
            <Form onSubmit={handleSubmit} className="w-full h-full flex flex-col justify-evenly">
                ...
                <Form.Input name="사료 급여량(하루 평균)" type="number" unit="kcal"/>
